                                ...
                                @elseif($isFull)
                                    ...
                                    <script>
                                        document.addEventListener('DOMContentLoaded', function() {
                                            setTimeout(function() {
                                                console.log('Attempting to show event full modal...');
                                                const modalElement = document.getElementById('eventFullModal');
                                                
                                                if (modalElement) {
                                                    // Vérifier que Bootstrap est chargé
                                                    if (typeof bootstrap !== 'undefined') {
                                                        console.log('Bootstrap is available, showing modal...');
                                                        const eventFullModal = new bootstrap.Modal(modalElement);
                                                        eventFullModal.show();
                                                    } else {
                                                        console.error('Bootstrap Modal not available, trying fallback...');
                                                        // Fallback: afficher la modal manuellement

                    ...
                    <div class="col-xl-5 col-lg-6 col-md-8 d-flex flex-column mx-auto">
                        <div class="card section-dark-bg border-0 shadow-hover-3d">
                            <div class="card-header pb-0 text-center bg-transparent">
                                <h3 class="font-weight-black text-dark-title display-6 mb-2">Bienvenue sur EcoEvents</h3>
                                <p class="text-muted mb-0">Connectez-vous pour participer aux événements écologiques</p>
                            </div>
                                ...
                                <form method="POST" action="{{ route('login') }}" role="form">
                                    ...
                                    <div class="mb-4">
                                        ...
                                        <div class="input-group input-group-alternative">
                                            ...
                                            <input type="email" name="email" class="form-control form-control-dark" placeholder="Votre adresse email" aria-label="Email" value="{{ old('email') }}" required autofocus autocomplete="username">
                                        </div>
                                    ...
                                    <div class="mb-4">
                                        ...
                                        <div class="input-group input-group-alternative">
                                            ...
                                            <input type="password" name="password" class="form-control form-control-dark" placeholder="Votre mot de passe" aria-label="Password" required autocomplete="current-password">
                                        </div>
                                    ...
                                    <div class="d-flex align-items-center mb-4">
                                        ...
                                        @if (Route::has('password.request'))
                                            <a href="{{ route('password.request') }}" class="text-success-bright text-xs font-weight-bold ms-auto">Mot de passe oublié ?</a>
                                        @endif
                                    </div>
                            ...
                            <div class="card-footer text-center pt-0 px-lg-5 px-3">
                                <p class="mb-4 text-muted">
                                    ...
                                    <a href="{{ route('register') }}" class="text-success-bright font-weight-bold">S'inscrire</a>
                                </p>
                            </div>
                        </div>
                    </div>

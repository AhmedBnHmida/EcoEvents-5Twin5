                ...
                <div class="col-md-12">
                    <div class="d-md-flex align-items-center mb-3 mx-2">
                        <div class="mb-md-0 mb-3">
                            ...
                            <p class="mb-0">
                                @if($user->isAdmin())
                                    Welcome Admin! Here are your platform stats.
                                @elseif($user->isFournisseur())
                                    Welcome Fournisseur! Here are your ressources.
                                @elseif($user->isOrganisateur())
                                    Welcome Organisateur! Here are your events and ressources.
                                @elseif($user->isParticipant())
                                    Welcome Participant! Here are your registrations and feedback.
                                @else
                                    Welcome!
                                @endif
                            </p>
                        ...
                        <div class="card border shadow-xs mb-4">
                            <div class="card-body text-start p-3 w-100">
                                ...
                                <div class="w-100">
                                    ...
                                    <h4 class="mb-2 font-weight-bold">{{ \App\Models\User::count() }}</h4>
                                </div>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="card border shadow-xs mb-4">
                            <div class="card-body text-start p-3 w-100">
                                ...
                                <div class="w-100">
                                    ...
                                    <h4 class="mb-2 font-weight-bold">{{ \App\Models\Event::count() }}</h4>
                                </div>
                            </div>
                        </div>
                    </div>
                    <div class="col-xl-3 col-sm-6 mb-xl-0">
                        <div class="card border shadow-xs mb-4">
                            <div class="card-body text-start p-3 w-100">
                                ...
                                <div class="w-100">
                                    <p class="text-sm text-secondary mb-1">Total Feedback</p>
                                    <h4 class="mb-2 font-weight-bold">{{ \App\Models\Feedback::count() }}</h4>
                                </div>
                            </div>
                        </div>
                    </div>
                    <div class="col-xl-3 col-sm-6 mb-xl-0">
                        <div class="card border shadow-xs mb-4">
                            <div class="card-body text-start p-3 w-100">
                                ...
                                <div class="w-100">
                                    <p class="text-sm text-secondary mb-1">Total Ressources</p>
                                    <h4 class="mb-2 font-weight-bold">{{ \App\Models\Ressource::count() }}</h4>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-xl-4 col-sm-6 mb-xl-0">
                        <div class="card border shadow-xs mb-4">
                            <div class="card-body text-start p-3 w-100">
                                ...
                                <div class="w-100">
                                    <p class="text-sm text-secondary mb-1">Your Ressources</p>
                                    <h4 class="mb-2 font-weight-bold">{{ $user->ressources()->count() }}</h4>
                                </div>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="card border shadow-xs mb-4">
                            <div class="card-body text-start p-3 w-100">
                                ...
                                <div class="w-100">
                                    ...
                                    <h4 class="mb-2 font-weight-bold">{{ \App\Models\Event::where('organisateur_id', $user->id)->count() }}</h4>
                                </div>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="card border shadow-xs mb-4">
                            <div class="card-body text-start p-3 w-100">
                                ...
                                <div class="w-100">
                                    ...
                                    <h4 class="mb-2 font-weight-bold">{{ $user->registrations()->count() }}</h4>
                                </div>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="card border shadow-xs mb-4">
                            <div class="card-body text-start p-3 w-100">
                                ...
                                <div class="w-100">
                                    ...
                                    <h4 class="mb-2 font-weight-bold">{{ $user->feedbacks()->count() }}</h4>
                                </div>
                            </div>
                        </div>
                    </div>
